...
enum ts_symbol_identifiers {
  ...
  anon_sym_delete = 62,
  anon_sym_handler = 63,
  anon_sym_middleware = 64,
  anon_sym_websocket = 65,
  anon_sym_udp = 66,
  anon_sym_tcp = 67,
  anon_sym_packet = 68,
  anon_sym_connection = 69,
  anon_sym_rtp = 70,
  anon_sym_model = 71,
  anon_sym_init = 72,
  anon_sym_app = 73,
  ...
  anon_sym_radius = 81,
  anon_sym_shadow = 82,
  anon_sym_shadowColor = 83,
  anon_sym_border = 84,
  anon_sym_borderColor = 85,
  anon_sym_variant = 86,
  anon_sym_children = 87,
  anon_sym_start = 88,
  anon_sym_center = 89,
  anon_sym_end = 90,
  anon_sym_appBar = 91,
  anon_sym_bottomBar = 92,
  anon_sym_overlays = 93,
  anon_sym_header = 94,
  anon_sym_footer = 95,
  anon_sym_item = 96,
  anon_sym_mark = 97,
  anon_sym_marker = 98,
  anon_sym_waypoint = 99,
  anon_sym_divider = 100,
  anon_sym_trigger = 101,
  anon_sym_group = 102,
  anon_sym_submenu = 103,
  anon_sym_megamenu = 104,
  anon_sym_icon = 105,
  anon_sym_column = 106,
  anon_sym_tab = 107,
  anon_sym_slide = 108,
  ...
  anon_sym_close = 141,
  anon_sym_drain = 142,
  sym_component_name = 143,
  sym_user_component_name = 144,
  sym_property_name = 145,
  anon_sym_DOT = 146,
  anon_sym_BANG = 147,
  anon_sym_QMARK2 = 148,
  anon_sym_SEMI = 149,
  sym_suite_marker = 150,
  sym_source_file = 151,
  sym_translation_catalog = 152,
  sym_translation_root = 153,
  sym_translation_line = 154,
  sym_translation_entry_line = 155,
  sym_translation_key_line = 156,
  sym_import_statement = 157,
  sym_import_specifiers = 158,
  sym_type_declaration = 159,
  sym_code_property_line = 160,
  sym_node_line = 161,
  sym_line_name = 162,
  sym_text_line = 163,
  sym_line_item = 164,
  sym_body_type_binding = 165,
  sym_request_json_binding = 166,
  sym_type_prop = 167,
  sym_prop = 168,
  sym_value = 169,
  sym_text_token = 170,
  sym_array = 171,
  sym_object = 172,
  sym_object_entry = 173,
  sym_spread = 174,
  sym_method_name = 175,
  sym_type_field = 176,
  sym_type_field_key = 177,
  sym_type_field_name = 178,
  sym_root_keyword = 179,
  sym_block_keyword = 180,
  sym_control_keyword = 181,
  sym_fn_keyword = 182,
  sym_identifier = 183,
  sym_punctuation = 184,
  aux_sym_source_file_repeat1 = 185,
  aux_sym_translation_catalog_repeat1 = 186,
  aux_sym_translation_catalog_repeat2 = 187,
  aux_sym_translation_root_repeat1 = 188,
  aux_sym_import_statement_repeat1 = 189,
  aux_sym_text_line_repeat1 = 190,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == '\r' ||
          lookahead == ' ') SKIP(28);
      if (('+' <= lookahead && lookahead <= '-')) ADVANCE(1512);
      if (lookahead == '_' ||
          ('x' <= lookahead && lookahead <= 'z')) ADVANCE(982);
      if (('H' <= lookahead && lookahead <= 'Z')) ADVANCE(982);
    ...
    case 2:
      ...
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('c' <= lookahead && lookahead <= 'z')) ADVANCE(1088);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n' &&
          (lookahead < '+' || ';' < lookahead) &&
    ...
    case 5:
      ...
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(1926);
      END_STATE();
    case 6:
      ADVANCE_MAP(
        '!', 1928,
      ...
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('c' <= lookahead && lookahead <= 'z')) ADVANCE(1924);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n' &&
          (lookahead < '+' || ';' < lookahead) &&
    ...
    case 7:
      ...
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('c' <= lookahead && lookahead <= 'z')) ADVANCE(1002);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n' &&
          (lookahead < '+' || ';' < lookahead) &&
    ...
    case 28:
      ...
      if (('+' <= lookahead && lookahead <= '-')) ADVANCE(1512);
      if (lookahead == '_' ||
          ('x' <= lookahead && lookahead <= 'z')) ADVANCE(1505);
      if (('H' <= lookahead && lookahead <= 'Z')) ADVANCE(1505);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(67);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n') ADVANCE(1515);
    ...
    case 30:
      ...
      if (('+' <= lookahead && lookahead <= '-')) ADVANCE(1512);
      if (lookahead == '_' ||
          ('k' <= lookahead && lookahead <= 'z')) ADVANCE(499);
      if (('H' <= lookahead && lookahead <= 'Z')) ADVANCE(1871);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(67);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n' &&
    ...
    case 53:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(1924);
      END_STATE();
    case 54:
    ...
    case 519:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('B' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('b' <= lookahead && lookahead <= 'z')) ADVANCE(982);
      END_STATE();
    case 520:
      ACCEPT_TOKEN(sym_type_reference);
    ...
    case 671:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'y')) ADVANCE(982);
      END_STATE();
    case 672:
      ACCEPT_TOKEN(sym_type_reference);
      if (lookahead == '[') ADVANCE(18);
    ...
    case 1057:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('b' <= lookahead && lookahead <= 'z')) ADVANCE(1088);
      END_STATE();
    case 1058:
      ACCEPT_TOKEN(sym_type_name);
      if (lookahead == '[') ADVANCE(19);
    ...
    case 1509:
      ...
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(87);
      if ((!eof && set_contains(sym_text_fragment_character_set_1, 12, lookahead))) ADVANCE(1515);
      END_STATE();
    case 1510:
      ACCEPT_TOKEN(sym_text_fragment);
    ...
    case 1623:
      ...
      if (lookahead == 'h') ADVANCE(1800);
      if (lookahead == 'i') ADVANCE(1706);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('B' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('b' <= lookahead && lookahead <= 'z')) ADVANCE(1871);
      END_STATE();
    case 1624:
      ACCEPT_TOKEN(sym_user_component_name);
      if (lookahead == '.') ADVANCE(1514);
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(1871);
      END_STATE();
    case 1625:
      ACCEPT_TOKEN(sym_user_component_name);
      if (lookahead == '.') ADVANCE(1514);
      if (lookahead == 'B') ADVANCE(1785);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(1871);
    ...
    case 1701:
      ...
      if (lookahead == 'z') ADVANCE(1801);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'y')) ADVANCE(1871);
      END_STATE();
    case 1702:
      ACCEPT_TOKEN(sym_user_component_name);
      if (lookahead == '.') ADVANCE(1514);
    ...
    case 1886:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('b' <= lookahead && lookahead <= 'z')) ADVANCE(1924);
      END_STATE();
    case 1887:
      ACCEPT_TOKEN(sym_property_name);
      if (lookahead == '.') ADVANCE(1514);
