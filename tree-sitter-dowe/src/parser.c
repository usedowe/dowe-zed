...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == '\r' ||
          lookahead == ' ') SKIP(28);
      if (('+' <= lookahead && lookahead <= '-')) ADVANCE(1832);
      if (lookahead == '_' ||
          ('x' <= lookahead && lookahead <= 'z')) ADVANCE(1132);
      if (('H' <= lookahead && lookahead <= 'Z')) ADVANCE(1132);
    ...
    case 2:
      ...
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('c' <= lookahead && lookahead <= 'z')) ADVANCE(1239);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n' &&
          (lookahead < '+' || ';' < lookahead) &&
    ...
    case 5:
      ...
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(2168);
      END_STATE();
    case 6:
      ADVANCE_MAP(
        '!', 2170,
      ...
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('c' <= lookahead && lookahead <= 'z')) ADVANCE(2164);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n' &&
          (lookahead < '+' || ';' < lookahead) &&
    ...
    case 28:
      ...
      if (('+' <= lookahead && lookahead <= '-')) ADVANCE(1832);
      if (lookahead == '_' ||
          ('x' <= lookahead && lookahead <= 'z')) ADVANCE(1804);
      if (('H' <= lookahead && lookahead <= 'Z')) ADVANCE(1804);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(68);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n') ADVANCE(1835);
    ...
    case 30:
      ...
      if (('H' <= lookahead && lookahead <= 'Z')) ADVANCE(2113);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(68);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n' &&
    ...
    case 54:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(2164);
      END_STATE();
    case 55:
    ...
    case 703:
      ...
      if (lookahead == 'z') ADVANCE(963);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'y')) ADVANCE(1132);
      END_STATE();
    case 704:
      ACCEPT_TOKEN(sym_type_reference);
      if (lookahead == '[') ADVANCE(18);
    ...
    case 1160:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('B' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('b' <= lookahead && lookahead <= 'z')) ADVANCE(1804);
      END_STATE();
    case 1161:
      ACCEPT_TOKEN(sym_type_name);
    ...
    case 1375:
      ...
      if (lookahead == 'z') ADVANCE(1635);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'y')) ADVANCE(1804);
      END_STATE();
    case 1376:
      ACCEPT_TOKEN(sym_type_name);
      if (lookahead == 'd') ADVANCE(1636);
    ...
    case 1808:
      ...
      if ((!eof && set_contains(sym_text_fragment_character_set_1, 12, lookahead))) ADVANCE(1835);
      END_STATE();
    case 1809:
      ACCEPT_TOKEN(sym_text_fragment);
    ...
    case 1862:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('B' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('b' <= lookahead && lookahead <= 'z')) ADVANCE(2113);
      END_STATE();
    case 1863:
      ACCEPT_TOKEN(sym_user_component_name);
      if (lookahead == '.') ADVANCE(1834);
      if (lookahead == 'B') ADVANCE(1903);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(2113);
      END_STATE();
    case 1864:
      ACCEPT_TOKEN(sym_user_component_name);
      if (lookahead == '.') ADVANCE(1834);
    ...
    case 1940:
      ...
      if (lookahead == 'z') ADVANCE(2041);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'y')) ADVANCE(2113);
      END_STATE();
    case 1941:
      ACCEPT_TOKEN(sym_user_component_name);
      if (lookahead == '.') ADVANCE(1834);
    ...
    case 2126:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('b' <= lookahead && lookahead <= 'z')) ADVANCE(2164);
      END_STATE();
    case 2127:
      ACCEPT_TOKEN(sym_property_name);
      if (lookahead == '.') ADVANCE(1834);
