...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == '\r' ||
          lookahead == ' ') SKIP(27);
      if (('+' <= lookahead && lookahead <= '-')) ADVANCE(1783);
      if (lookahead == '_' ||
          ('x' <= lookahead && lookahead <= 'z')) ADVANCE(1099);
      if (('H' <= lookahead && lookahead <= 'Z')) ADVANCE(1099);
    ...
    case 1:
      ...
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('c' <= lookahead && lookahead <= 'z')) ADVANCE(480);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n' &&
    ...
    case 2:
      ...
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('c' <= lookahead && lookahead <= 'z')) ADVANCE(1205);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n' &&
          lookahead != ']' &&
    ...
    case 4:
      ...
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(2120);
      END_STATE();
    case 5:
      ADVANCE_MAP(
        '!', 2122,
      ...
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('c' <= lookahead && lookahead <= 'z')) ADVANCE(2116);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n' &&
          (lookahead < '+' || ';' < lookahead) &&
    ...
    case 6:
      ...
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('c' <= lookahead && lookahead <= 'z')) ADVANCE(1119);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n' &&
          (lookahead < '+' || ';' < lookahead) &&
    ...
    case 27:
      ...
      if (('+' <= lookahead && lookahead <= '-')) ADVANCE(1783);
      if (lookahead == '_' ||
          ('x' <= lookahead && lookahead <= 'z')) ADVANCE(1755);
      if (('H' <= lookahead && lookahead <= 'Z')) ADVANCE(1755);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(67);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n') ADVANCE(1786);
    ...
    case 29:
      ...
      if (('+' <= lookahead && lookahead <= '-')) ADVANCE(1783);
      if (lookahead == '_' ||
          ('x' <= lookahead && lookahead <= 'z')) ADVANCE(480);
      if (('H' <= lookahead && lookahead <= 'Z')) ADVANCE(2065);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(67);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n' &&
    ...
    case 53:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(2116);
      END_STATE();
    case 54:
    ...
    case 1121:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(1755);
      END_STATE();
    case 1122:
      ACCEPT_TOKEN(sym_type_name);
      if (lookahead == '.') ADVANCE(1762);
    ...
    case 1127:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('B' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('b' <= lookahead && lookahead <= 'z')) ADVANCE(1755);
      END_STATE();
    case 1128:
      ACCEPT_TOKEN(sym_type_name);
    ...
    case 1337:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'y')) ADVANCE(1755);
      END_STATE();
    case 1338:
      ACCEPT_TOKEN(sym_type_name);
      if (lookahead == 'd') ADVANCE(1591);
    ...
    case 1759:
      ...
      if ((!eof && set_contains(sym_text_fragment_character_set_1, 12, lookahead))) ADVANCE(1786);
      END_STATE();
    case 1760:
      ACCEPT_TOKEN(sym_text_fragment);
    ...
    case 1814:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('B' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('b' <= lookahead && lookahead <= 'z')) ADVANCE(2065);
      END_STATE();
    case 1815:
      ACCEPT_TOKEN(sym_user_component_name);
      if (lookahead == '.') ADVANCE(1785);
    ...
    case 1892:
      ...
      if (lookahead == 'z') ADVANCE(1993);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'y')) ADVANCE(2065);
      END_STATE();
    case 1893:
      ACCEPT_TOKEN(sym_user_component_name);
      if (lookahead == '.') ADVANCE(1785);
    ...
    case 2078:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('b' <= lookahead && lookahead <= 'z')) ADVANCE(2116);
      END_STATE();
    case 2079:
      ACCEPT_TOKEN(sym_property_name);
      if (lookahead == '.') ADVANCE(1785);
