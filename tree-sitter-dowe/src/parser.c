...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == '\r' ||
          lookahead == ' ') SKIP(28);
      if (('+' <= lookahead && lookahead <= '-')) ADVANCE(1654);
      if (lookahead == '_' ||
          ('x' <= lookahead && lookahead <= 'z')) ADVANCE(1011);
      if (('H' <= lookahead && lookahead <= 'Z')) ADVANCE(1011);
    ...
    case 2:
      ...
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('c' <= lookahead && lookahead <= 'z')) ADVANCE(1117);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n' &&
          (lookahead < '+' || ';' < lookahead) &&
    ...
    case 6:
      ...
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('c' <= lookahead && lookahead <= 'z')) ADVANCE(1985);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n' &&
          (lookahead < '+' || ';' < lookahead) &&
    ...
    case 7:
      ...
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('c' <= lookahead && lookahead <= 'z')) ADVANCE(1031);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n' &&
          (lookahead < '+' || ';' < lookahead) &&
    ...
    case 28:
      ...
      if (('+' <= lookahead && lookahead <= '-')) ADVANCE(1654);
      if (lookahead == '_' ||
          ('x' <= lookahead && lookahead <= 'z')) ADVANCE(1626);
      if (('H' <= lookahead && lookahead <= 'Z')) ADVANCE(1626);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(62);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n') ADVANCE(1657);
    ...
    case 30:
      ...
      if (('H' <= lookahead && lookahead <= 'Z')) ADVANCE(1934);
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(62);
      if (lookahead != 0 &&
          lookahead != '\t' &&
          lookahead != '\n' &&
    ...
    case 456:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('B' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('b' <= lookahead && lookahead <= 'z')) ADVANCE(1011);
      END_STATE();
    case 457:
      ACCEPT_TOKEN(sym_type_reference);
    ...
    case 624:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'y')) ADVANCE(1011);
      END_STATE();
    case 625:
      ACCEPT_TOKEN(sym_type_reference);
      if (lookahead == '[') ADVANCE(18);
    ...
    case 1039:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('B' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('b' <= lookahead && lookahead <= 'z')) ADVANCE(1626);
      END_STATE();
    case 1040:
      ACCEPT_TOKEN(sym_type_name);
    ...
    case 1239:
      ...
      if (lookahead == 'z') ADVANCE(1478);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'y')) ADVANCE(1626);
      END_STATE();
    case 1240:
      ACCEPT_TOKEN(sym_type_name);
      if (lookahead == 'd') ADVANCE(1473);
    ...
    case 1630:
      ...
      if (lookahead == 'Q') ADVANCE(1651);
      if ((!eof && set_contains(sym_text_fragment_character_set_1, 12, lookahead))) ADVANCE(1657);
      END_STATE();
    case 1631:
      ACCEPT_TOKEN(sym_text_fragment);
    ...
    case 1684:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('B' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('b' <= lookahead && lookahead <= 'z')) ADVANCE(1934);
      END_STATE();
    case 1685:
      ACCEPT_TOKEN(sym_user_component_name);
      if (lookahead == '.') ADVANCE(1656);
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(1934);
      END_STATE();
    case 1686:
      ACCEPT_TOKEN(sym_user_component_name);
      if (lookahead == '.') ADVANCE(1656);
    ...
    case 1762:
      ...
      if (lookahead == 'z') ADVANCE(1864);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'y')) ADVANCE(1934);
      END_STATE();
    case 1763:
      ACCEPT_TOKEN(sym_user_component_name);
      if (lookahead == '.') ADVANCE(1656);
